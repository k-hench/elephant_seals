#!/usr/bin/env Rscript
# ---------------------
# by Kosmas Hench, mainly still Joana Meier's code
# adapted to work with fastsimcoal > v2.7
# (which dropped the "RULES" section in the .est files)
# ---------------------
# Usage: Rscript calculateAIC_kh.R modelprefix
...
k<-(grep("COMPLEX",est))-(grep("//all Ns are",est)+2)
