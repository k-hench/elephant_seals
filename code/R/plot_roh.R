...
import_roh <- function(ref, partition){
  read_tsv(here("results", "roh", "bcftools", glue("{ref}_{partition}_roh.tsv.gz")),
           skip = 4,
...
ggsave("~/Downloads/mirang_roh_max_callable.pdf", width = 16, height = 6, device = cairo_pdf)
